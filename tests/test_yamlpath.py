...
from yamlpath import Processor, Parser
...
def test_wrap_type(val, typ):
  assert isinstance(Processor.wrap_type(val), typ)
...
def test_premade_parser(quiet_logger):
  ...
  preload = Processor(quiet_logger, parser=premade)
